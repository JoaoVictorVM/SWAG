export default function Footer() {
    return (
        <footer className="h-auto py-10 flex flex-col items-center justify-center gap-4 text-center sm:flex-row sm:gap-10 lg:gap-20 uppercase font-[prata] text-[var(--color-text)] text-[0.9rem] sm:text-[1rem] font-black transform scale-y-70">
